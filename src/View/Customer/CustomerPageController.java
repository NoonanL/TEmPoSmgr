...
public class CustomerPageController {
    ...
    private void showEditCustomerDialog(Customer customer){
        try {
            ...
            loader.setLocation(TEmPoSmgr.class.getResource("/View/Customer/EditCustomer.fxml"));
    ...
    private void showCreateNewCustomer() {
        try {
            // Load the fxml file and create a new stage for the popup dialog.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(TEmPoSmgr.class.getResource("/View/Customer/CreateCustomer.fxml"));
            AnchorPane page = loader.load();
